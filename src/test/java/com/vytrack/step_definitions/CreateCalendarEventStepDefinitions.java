...
public class CreateCalendarEventStepDefinitions {
    ...
    /*
        ...
        Whenever we have two column of data, beter to use Map.
        These data will be stored in the object of "data"
        If we have three column of data, then we use List of Map, not Map
     */
