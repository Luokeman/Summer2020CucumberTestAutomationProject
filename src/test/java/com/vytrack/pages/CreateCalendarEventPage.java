...
public class CreateCalendarEventPage extends BasePage {
 ...
 // for the description box we have iframe , so we have to handle that.
 public void enterDescription(String text){
     WebDriverWait wait  = new WebDriverWait(Driver.getDriver(),20);

     //this following step is for to exit from all frames
     ...
     //enter text
    // BrowserUtils.enterText(descriptionInputBox,text);  this step didint work
